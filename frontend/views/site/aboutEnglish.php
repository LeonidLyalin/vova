...
<table style = "width: 100%;" border = "0" cellspacing = "0" cellpadding = "0">
    ...
        <tbody>
        ...
                <tr height = "20">
            ...
                    </tr>
                <tr height = "50">
                        <td width = "158" height = "50" class = "tablenoborder"> Mode: </td>
...
<ul style = "text-align: justify;">
    ...
        <li> <span style = "font-size: small;"> <span class = "pagetext"> <span style = "font-size: medium;"> <?=Yii::t('about','lighting of public spaces;')?> </span> </span>
                    </span>
            </li>
        <li> <span style = "font-size: small;"> <span class = "pagetext"> <span style = "font-size: medium;"> <?=Yii::t('about','software installed Russian Federation Temperature legislation and humidity in common areas;')?> </span> </span>
                    </span>
            </li>
...
<ul style = "text-align: justify;">
    ...
        <li> <span style = "font-size: small;"> <span class = "pagetext"> <span style = "font-size: medium;"> <?=Yii::t('about','the issuance of extracts from the personal account;')?> </span> </span>
                    </span>
            </li>
        <li> <span style = "font-size: small;"> <span class = "pagetext"> <span style = "font-size: medium;"> <?=Yii::t('about','the collection, processing payments from the population and settlements with the population;')?> </span> </span>
                    </span>
            </li>
        <li> <span style = "font-size: small;"> <span class = "pagetext"> <span style = "font-size: medium;"> <?=Yii::t('about','integrated processing payments of the population;')?> </span> </span>
                    </span>
            </li>
        <li> <span style = "font-size: small;"> <span class = "pagetext"> <span style = "font-size: medium;"> <?=Yii::t('about','calculations of utility services providers;')?> </span> </span>
                    </span>
            </li>
    ...
        <li> <span style = "font-size: small;"> <span class = "pagetext"> <span style = "font-size: medium;"> <?=Yii::t('about','monthly payment and payment for utility services issue a single payment document;')?> </span> </span>
                    </span>
            </li>
        <li> <span style = "font-size: small;"> <span class = "pagetext"> <span style = "font-size: medium;"> <?=Yii::t('about','receive payments from the population for housing, utilities and other services;')?> </span> </span>
                    </span>
            </li>
        <li> <span style="font-size: small;"> <span class="pagetext"> <span style="font-size: medium;"> <?=Yii::t('about','conduct claim work with the population, with the owners and tenants of non-residential facilities;')?> </span> </span>
                    </span>
            </li>
</ul>
