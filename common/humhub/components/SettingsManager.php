...
use Yii;
use common\humhub\libs\BaseSettingsManager;
use common\humhub\modules\content\components\ContentContainerActiveRecord;
use common\humhub\modules\content\components\ContentContainerSettingsManager;
...
class SettingsManager extends BaseSettingsManager
{
    ...
    {
        if (Yii::$app->controller instanceof \common\humhub\modules\content\components\ContentContainerController) {
            if (Yii::$app->controller->contentContainer instanceof \common\humhub\modules\space\models\Space) {
