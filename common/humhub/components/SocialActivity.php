...
use common\humhub\libs\Viewable;
...
abstract class SocialActivity extends Viewable
{
     ...
     * @return string
     */
    public function getContentInfo(\common\humhub\modules\content\interfaces\ContentTitlePreview $content)
    {
