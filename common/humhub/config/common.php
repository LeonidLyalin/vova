<?php
/**
 * Set humhub parameter -very important file!
 * 
 */
...
/**
 * Slightly move alias humhum - add common
 */
//Yii::setAlias('@humhub', '@app/humhub');
Yii::setAlias('@humhub', '@app/common/humhub');
...
$config = [
    ...
    'components' => [
        'moduleManager' => [
            'class' => '\common\humhub\components\ModuleManager'
        ],
        'log' => [
        ...
        'search' => array(
            'class' => 'common\humhub\modules\search\engine\ZendLuceneSearch',
        ),
        'settings' => array(
        ...
        'mailer' => [
            ...
            'view' => [
                'class' => '\common\humhub\components\View',
                'theme' => [
                    'class' => '\common\humhub\components\Theme',
                    'name' => 'HumHub'
                ],
            ],
        ],
        'assetManager' => [
            'class' => '\common\humhub\components\AssetManager',
        ...
        'authClientCollection' => [
            'class' => 'common\humhub\modules\user\authclient\Collection',
            'clients' => [],
        ],
    ],
    'params' => [
