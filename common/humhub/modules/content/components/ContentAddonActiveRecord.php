...
use common\humhub\modules\content\components\ContentAddonActiveRecord;
 ...
 * @since 0.5
 */
class ContentAddonActiveRecord extends ActiveRecord implements \common\humhub\modules\content\interfaces\ContentTitlePreview
{
    ...
    {
        return $this->hasOne(\common\humhub\modules\user\models\User::className(), ['id' => 'created_by']);
    }
