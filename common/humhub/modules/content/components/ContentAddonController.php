 ...
 * @version 0.11
 */
class ContentAddonController extends \common\humhub\components\Controller
{
    ...
    {
        if (!\common\humhub\libs\Helpers::CheckClassType($className, ContentAddonActiveRecord::className())) {
