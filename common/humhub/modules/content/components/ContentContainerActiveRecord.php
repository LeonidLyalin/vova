...
use common\humhub\libs\ProfileBannerImage;
use common\humhub\libs\ProfileImage;
use common\humhub\modules\user\models\User;
use common\humhub\components\ActiveRecord;
use common\humhub\modules\content\models\ContentContainer;
use common\humhub\modules\content\models\Wall;
...
class ContentContainerActiveRecord extends ActiveRecord
{
    ...
    {
        if ($this instanceof \common\humhub\modules\space\models\Space) {
