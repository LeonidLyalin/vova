...
use common\humhub\components\Controller;
    ...
    public function init()
    {
        ...
        if ($spaceGuid != "") {
            ...
            $this->attachBehavior('SpaceControllerBehavior', array(
                'class' => \common\humhub\modules\space\behaviors\SpaceController::className(),
            ...
            $this->attachBehavior('ProfileControllerBehavior', [
                'class' => \common\humhub\modules\user\behaviors\ProfileController::className(),
