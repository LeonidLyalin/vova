...
return [
    ...
    'Kim Sergey Voncherovich' => '金谢尔盖Voncherovich',
    ...
    'calculations of utility services providers;' => '公用服务提供商的计算;',
    ...
    'conduct claim work with the population, with the owners and tenants of non-residential facilities;' => '随着人口的行为索赔工作中，与业主和非住宅设施的住户;',
    ...
    'integrated processing payments of the population;' => '综合人口处理付款;',
    ...
    'receive payments from the population for housing, utilities and other services;' => '接收来自人口对住房，公用事业及其他服务费;',
    ...
    'software installed Russian Federation Temperature legislation and humidity in common areas;' => '安装了俄罗斯联邦立法的温度和湿度的公共区域软件;',
    'the collection, processing payments from the population and settlements with the population;' => '收集，从人口和人口聚居处理付款;',
